...
async function main() {
    ...
    fs.writeFileSync(process.cwd() + '/deployments/deployments.json', JSON.stringify(deployments.data, null, 2));
    fs.writeFileSync(process.cwd() + '/deployments/config.json', JSON.stringify(config.data, null, 2));
}
