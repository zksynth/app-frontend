			...
			</Head>
			{
				<Flex flexDir={'column'} mt={10} mb={10} gap={3}>
					<Flex
						...
						gap={3}
						>
						<Box width={{sm: '100%', md: '28%'}} bgColor='gray.700' border='1px' borderColor='rgba(255, 255, 255, 0.04)' rounded={15}>
							<Collateral handleChange={handleChange} />
						</Box>
						<Box width={{sm: '100%', md: '72%'}} bgColor='gray.700' border='1px' borderColor='rgba(255, 255, 255, 0.04)' rounded={15}>
							<Borrow />
						</Box>
					</Flex>
